...
import re
from nalpy.humanizer.numbers import number_to_words_converter, heading_converter
...
def to_heading(degrees_num: int) -> str:
    return heading_converter.get_heading_from_set(degrees_num, heading_converter.HEADINGS_LONG)

def to_abbreviated_heading(degrees_num: int) -> str:
    return heading_converter.get_heading_from_set(degrees_num, heading_converter.HEADINGS_SHORT)

def to_heading_arrow(degrees_num: int) -> str:
    return heading_converter.get_heading_from_set(degrees_num, heading_converter.HEADINGS_ARROW)
